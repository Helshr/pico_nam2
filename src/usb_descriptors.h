...
#define TUD_AUDIO_INTERFACE_STEREO_DESC_LEN (TUD_AUDIO20_DESC_IAD_LEN\
...
#define TUD_AUDIO_INTERFACE_STEREO_DESCRIPTOR(_stridx, _epout, _epin, _epint) \
    ...
    /* The audio function owns exactly AC + speaker AS + mic AS.  Using
       ITF_NUM_TOTAL here also captures later CDC/HID interfaces inside the
       audio IAD, preventing macOS and Chromium from binding their drivers. */\
    ...
    /* Input Terminal Descriptor(4.7.2.4) */\
    TUD_AUDIO20_DESC_INPUT_TERM(/*_termid*/ UAC2_ENTITY_MIC_INPUT_TERMINAL, /*_termtype*/ AUDIO_TERM_TYPE_IN_GENERIC_MIC, /*_assocTerm*/ 0x00, /*_clkid*/ UAC2_ENTITY_CLOCK, /*_nchannelslogical*/ 0x02, /*_channelcfg*/ AUDIO20_CHANNEL_CONFIG_NON_PREDEFINED, /*_idxchannelnames*/ 0x00, /*_ctrl*/ 0 * (AUDIO20_CTRL_R << AUDIO20_IN_TERM_CTRL_CONNECTOR_POS), /*_stridx*/ 0x00),\
    /* Output Terminal Descriptor(4.7.2.5) */\
...
// Defined in main.c: notified on AS alt-setting changes (mic stream open/close).
